class CreateCrawls < ActiveRecord::Migration
  ...
  def self.up
    create_table :crawls do |t|
      ...
      t.integer    :total_product_inventory_count,                 :default => 0, :limit => 8
      t.integer    :total_product_inventory_volume_in_milliliters, :default => 0, :limit => 8
      t.integer    :total_product_inventory_price_in_cents,        :default => 0, :limit => 8
